...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if($interests->count() < 1)
                        <h6 style = "color :#2b2b2b">No Results Found!!</h6>
                    @else
                        @foreach($interests as $i)
                            <a class = "ml-3" href ="/interest/{{$i}}" style="color: #2b2b2b; font-weight: bold;font-size:20px">{{\App\Models\Interest::find($i)->name}}</a>
                            <br>
                        @endforeach
                    @endif
                </div>
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header" style="z-index: -1;">{{ __('Courses Resaults :') }}</div>
                ...
                <div class="card-body d-inline">
                    ...
                    @endif
                    <h4 style = "color :#e1b12c">Courses :</h4>
                    <br>
                    @if($courses->count() < 1)
                        <h3 style = "color :#2b2b2b">No Results Found!!</h3>
                    @else
                        @foreach($courses as $cs)
                            ...
                            @if($loop->index%3 == 2 && $loop->count != $loop->index)
                                </div>
                            @endif
                        @endforeach
                        </div>
                    ...
                    <hr>
                    <!-- Authors -->
                    <h4 style = "color :#e1b12c">By Authors :</h4>
                    <br>
                    @if($authors->count() < 1)
                        <h3 style = "color :#2b2b2b">No Results Found!!</h3>
                    @else
                        @foreach($authors as $cs)
                            @if($loop->index%3 == 0)
                                <div class = "row">
                            @endif
                    ...
                    <hr>
                    <!-- Interests -->
                    <h4 style = "color :#e1b12c">By Interests :</h4>
                    <br>
                    @if($CbyI->count() < 1)
                        <h3 style = "color :#2b2b2b">No Results Found!!</h3>
                    @else
