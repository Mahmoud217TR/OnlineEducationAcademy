<template>
        <button class="btn btn-primary mt-3" style="margin: auto ;" @click="favoriteThis">
...
<script>
export default {
    props: ['courseId','interestId','interested','path'],
    ...
    methods: {
        favoriteThis(){
            axios.post('/hasInterest/'+this.courseId+'/'+this.interestId)
                .then(response => {
